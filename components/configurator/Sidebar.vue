...
import { PROVIDED_KEY } from "~/constants/index";
...
<template>
  <div
    ref="sideBar"
    class="h-[500px] max-sm:w-full border  h-content relative bg-[#EEEDE8] max-sm:sticky bottom-0"
  >
    <div
      class="sm:flex sm:flex-col bg-[#EEEDE8] sm:justify-between sm:w-[310px] sm:h-full w-full box-border max-sm:fixed bottom-0"
    >
      <SideBarMenu
